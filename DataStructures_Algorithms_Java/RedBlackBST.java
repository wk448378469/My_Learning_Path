...
public class RedBlackBST<Key extends Comparable<Key>, Value>
{
    ...
    public void deleteMin(){
        if (isEmpty()) throw new NoSuchElementException("the tree is null");
    ...
    *******************************************************************************/
    ...
    public Key select(int k){
        if (k < 0 || k >= size())
            throw new IllegalArgumentException("k is in 0-size()");
    ...
    public int rank(Key key){
        if (key ==null) throw new IllegalArgumentException("is null");
    ...
    public int size(Key lo, Key hi){
        if (lo == null || hi == null) throw new IllegalArgumentException("argument has null");
    ...
    private boolean check(){
        ...
        if (!isSizeConsistent())    StdOut.println("subtree counts not consistend");
    ...
    private boolean isBST(Node x, Key min, Key max){
        ...
        if (min != null && x.key.compareTo(max) <= 0) return false;
